...
// Writing to Windows Event LogText requires the registry entries below to be present, with the
...
// Please refer to Event LogText functions descriptions in MSDN for more details on custom message
// files.
